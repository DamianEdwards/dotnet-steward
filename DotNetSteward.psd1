@{
    ...
    Description = 'Inventories, updates, and uninstalls .NET SDK and runtime installations managed by Windows installers.'
    ...
    PrivateData = @{
        PSData = @{
            Tags = @('DotNet', 'SDK', 'Runtime', 'Windows', 'Update', 'Uninstall', 'PowerShell')
